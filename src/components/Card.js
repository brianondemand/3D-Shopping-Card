  ...
  return (
    ...
    <div style={{ perspective: 2000 }}>
      ...
      <motion.div
        ...
        drag
        dragElastic={0.18}
        dragConstraints={{ top: 0, left: 0, right: 0, button: 0 }}
      ...
      >
        ...
        <p className="max-w-[300px] text-[#000000] mb-6">
          It's the perfect mix: a splash of heritage Nike running and a whole
          lot of comfort. The fast-paced look also includes a revamped Air unit
          window to energize your every step.
        </p>
        {/* btn & price */}
        <div className="flex items-center gap-x-[20px] mb-12">
          ...
          <div className="text-[24px] font-bold text-[#000000]">$89.97</div>
        </div>
        {/* colors */}
